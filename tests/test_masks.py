...
def test_invalid_card_number(invalid_data: Union[str, int]) -> None:
...
@pytest.mark.parametrize("invalid_data", [47563247562385258724568325, 23434342, 0, ""])
def test_invalid_account_number(invalid_data: Union[str, int]) -> None:
    with pytest.raises(ValueError):
